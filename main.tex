...
sequence are statistically more dependent.
...
Our LSTM aims to simultaneously learn vector representations of user
and items by considering the user as a ``global context", correspondingly.
